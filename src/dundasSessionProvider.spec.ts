...
import { DundasSessionProvider } from './dundasSessionProvider';


describe('api', () => {
  let request;
  let logger: dundas.Logger = {
  ...
  it('should create a new dundas session', () => {
    let accounts: dundas.DundasAccount[] = [
      {
        accountName: 'user1',
        password: 'pass1',
    ...
    let provider = new DundasSessionProvider('http://dundasUrl:456/AppPath', 'adminAccount', 'adminPass', accounts, request);
